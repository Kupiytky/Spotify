...
export default function GetStarted({ navigation }) {
    return (
        <View style={styles.container}>
            ...
            <Image source={require('../assets/drake.svg')} style={{ width: 335, height: 370, borderRadius: 30, marginVertical: 45, marginHorizontal: 50 }} />

            <View style={{ marginVertical: -5 }} >
                <Text style={ [styles.text, {width: 200, color: '#E1E1E1', fontSize: 30, marginVertical: -25, marginHorizontal: 20, fontWeight: 'bold', lineHeight: 27, }]}>Scorpion</Text>
                <Text style={ [styles.text, { color: '#E1E1E1', fontSize: 20, marginVertical: 30, marginHorizontal: 35, width: 100, }]}>Drake</Text>
            </View>
